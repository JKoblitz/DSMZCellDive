        ...
        <div class="row">
            <div class="col-lg-6 align-vertical-center">
                <div class="content mx-auto" style="max-width: 50rem;">
                    <h2 class="mb-0 ">Breast cancer panel</h2>
                    <h4 class="mt-0 text-primary font-weight-normal">Coming soon...</h5>
            ...
            <div class="col-lg-6 align-vertical-center">
                <div class="content">
                    <img src="<?= ROOTPATH ?>/img/breast-cancer.jpg" alt="" class="img-fluid rounded">
                </div>
            </div>
        </div>
