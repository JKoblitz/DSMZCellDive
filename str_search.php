...
<a href="<?= ROOTPATH ?>/documentation#str" class="btn btn-help float-right"><i class="fal fa-lg fa-book mr-5"></i> <span class="d-none d-md-inline">Help</span></a>
    ...
    <ul class="unordered-list">
        <li>The human STR profile database includes data sets of 2455 cell lines from ATCC, DSMZ, JCRB and RIKEN <br>
        </li>
        <li>Clicking on the locus names will link you to further infos </li>
        <li><a href="help.html">How to use the search engine</a>. </li>
    </ul> -->
...
<div class="mx-20">
<button class="btn btn-primary" type="button" onclick="halfmoon.toggleModal('text-input')">Use text input</button></div>
